...
export default function GamesDetail({navigation}) {
    ...
    const getTimeLabel = () => {
        ...
        return formatAMPM(new Date(route.params?.data['data'].game.startTimeUTC))
        ...
        <SafeAreaView style={{width: '100%', position: 'relative'}}>
            <View
                ...
                <View style={{flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center'}}>
                    ...
                    {!scrollView ? <Text style={{
                            fontFamily: 'Sora_600SemiBold',
                            fontSize: 24
                        }}>{route.params?.data.data.awayTeam.abbrev} @ {route.params?.data.data.homeTeam.abbrev}</Text> :
                        <Text style={{
                            fontFamily: 'Sora_600SemiBold',
                            fontSize: 24
                        }}>{route.params?.data.data.awayTeam.abbrev} {matchData?.away.score} • {matchData?.home.score} {route.params?.data.data.homeTeam.abbrev}</Text>}
                </View>
                {
            ...
            <ScrollView scrollEventThrottle={16} onScroll={(s) => handleScroll(s.nativeEvent.contentOffset.y)}
                        ...
                        <View>
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    ...
                                    textAlign: 'center',
                                    fontFamily: 'Sora_500Medium'
                                }}>{route.params?.data['data']?.period > 3 ? "OT" : `P${route.params?.data['data'].period}`} • {getTimeLabel()}</Text>
                            </View>
                        </View>
                        {matchData?.home !== undefined ?
                            ...
                            <View
                                ...
                                <Text style={{
                                    ...
                                    fontSize: 32
                                }}>{matchData?.home.score}•{matchData?.away.score}</Text>
                            </View> : <View style={{
                                backgroundColor: '#f7f7f7',
                                paddingVertical: 5,
                                paddingHorizontal: 20,
                ...
                <Progress.Bar color={getPCTColor(route.params?.data.data.homeTeam.abbrev)}
                              ...
                              borderWidth={0} style={{marginTop: 20}} progress={stat.home ?? 0} height={12}
            ...
            <View style={{marginTop: 20}}>
                <ScrollView showsHorizontalScrollIndicator={false} horizontal style={{
...

                    {
                        route.params?.data['data']['goals'] !== undefined ? <
                            ...
                            <Svg
                                ...
                                stroke={tab === 0 ? "white" : "black"} strokeWidth="1.5"
                                strokeLinecap="round"
                    ...
                    >
                        <Chart2 color={tab === 2 ? "white" : "black"}/>
                    ...
                    }
                    {
                        route.params?.data['data']['goals'] !== undefined ? <
                            ...
                            <UserRemove color={tab === 4 ? "white" : "black"}/>
                    ...
                    !tab && route.params?.data['data']['goals'] !== undefined ?
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity onPress={() => {
                                        ...
                                        <Text style={{
                                            ...
                                            textAlign: 'center',
                                            opacity: .5
                                        }}>{goal.homeScore} • {goal.awayScore}</Text>
                                        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                                            <Image style={{
                                                borderRadius: 100,
                                                borderWidth: 3,
                                        ...
                                        <Text style={{
                                            ...
                                            textAlign: 'center',
                                            opacity: .5
                                        }}>{goal.timeInPeriod} • {goal.strength}</Text>
                                    </TouchableOpacity>
                                </View>
                            ...
                            <View>
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                        ...
                                        <Text
                                            style={{fontFamily: 'Sora_500Medium', fontSize: 16}}>{isReg ? "REG" : "OT"} Win
                                            Playoff %</Text>
                                        <Text style={{
                                            fontFamily: 'Sora_500Medium',
                                            fontSize: 16,
                                    ...
                                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                        <Progress.Bar color={getPCTColor(route.params?.data.data.homeTeam.abbrev)}
                                                      unfilledColor={'#f7f7f7'} borderRadius={100} borderWidth={0}
                                        ...
                                        <TouchableOpacity onPress={() => {
                                            Haptics.selectionAsync().then(r => {
                                                setHomeStat(true)
                                                          ...
                                                          style={{
                                                              backgroundColor: homeStat ? 'black' : '#f7f7f7',
                                                              borderRadius: 100
                                                          }}>
                                            <Text style={{
                                                textAlign: "left",
                        ...
                        />
                                <Text style={{
                                    ...
                                    fontSize: 24,
                                    marginTop: 0
                                }}>{homeStat ? route.params?.data.data.homeTeam.abbrev : route.params?.data.data.awayTeam.abbrev} Expected
                                    Goals</Text>
                                        ...
                                        datasets: [
                                            {
                                                color: (opacity) => `${getPCTColor("NYI")}`,
                                                strokeWidth: 2,
                                                data: homeStat ? ptsData.h.map((r, i) => {
                                                    return isNaN(r) ? ptsData.h[i - 1] : r
                                                }) : ptsData.a.map((r, i) => {
                                                    return isNaN(r) ? ptsData.a[i - 1] : r
                                                })
                                            }
                                        ]
                                    }}
                                                    ...
                                                    <View style={{
                                                        ...
                                                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                                            <Text style={{
                                                                fontFamily: 'Sora_700Bold',
                                                                fontSize: 16,
                                                                color: `${play.raw.split(' ')[0].length === 3 ? getPCTColor(play.raw.split(' ')[0]) : 'black'}`
                                    ...
                                    <View>
                                        ...
                                        <Table>
                                            ...
                                            {playerStats.h ? playerStats.h?.sort(sort_by('goals', true, parseInt)).map((player) => {
                                                return <Row textStyle={{fontFamily: 'Sora_500Medium', marginTop: 10}} widthArr={[60, 120, 100, 100, 100, 100, 100, 100, 100]} data={[ player.position, player.name.default, player.goals, player.assists, player.shots, player.toi, player.blockedShots, player.hits, player.plusMinus]}/>
                                            }) : <></>}
                                            <View style={{width: '100%', borderWidth: 2, borderColor: 'black', opacity: .5, borderStyle: 'dotted', marginVertical: 10}}/>
                                            <Row textStyle={{fontFamily: 'Sora_600SemiBold'}} widthArr={[60, 120, 100, 100, 100, 100]} data={["Pos", "Name", "Save %", "Saved", "GA", "TOI"]}/>

                                            {playerStats.g.h ? playerStats.g.h?.sort(sort_by('goalsAgainst', true, parseFloat)).map((player) => {
                                                return <Row textStyle={{fontFamily: 'Sora_500Medium', marginTop: 10}} widthArr={[60, 120, 100, 100, 100, 100]} data={[ player.position, player.name.default, player.savePctg ?? 0, player.saveShotsAgainst, player.goalsAgainst, player.toi]}/>
                                            }) : <></>}
                                        </Table>
                                        <View style={{marginTop: 20}}>
                                            <Text style={{
